package me.kbejj.core.toast;

import me.kbejj.core.Core;
import me.kbejj.core.utils.TimeUtil;
...
public class Toast {
    ...
    private Toast(String icon, String message, Style style) {
        this.key = new NamespacedKey(Core.getPlugin(), UUID.randomUUID().toString());
        this.icon = icon;
    ...
    public void start(Player player) {
        ...
        TimeUtil.delay(() -> revokeAdvancement(player));
    }
    ...
    public static void sendToPlayer(Player player, String icon, String message, Style style) {
